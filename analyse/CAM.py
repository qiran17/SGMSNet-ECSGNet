...
# airplane57.tif baseballdiamond46.tif forest08.tif freeway39.tif harbor70.tif overpass48.tif river32.tif tenniscourt51.tif
def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--use-cuda', action='store_true', default=True, help='Use NVIDIA GPU acceleration')
    parser.add_argument('--image-path', type=str, default="./pic/harbor70.tif", help='Input image path')
    parser.add_argument('--output-image-path', type=str, default="./result/cam_harbor70.tif", help='Output image path')
    parser.add_argument('--model', type=str, default='ECSGNet', help='model name')
...
if __name__ == '__main__':
    ...
    model = torch.load('../ECSGNet_forcam-best.pth', map_location='cpu')
    reshape_transform = None
    #print(model.block4[-1].attn)
    if 'ECSGNet' in args.model:
        target_layers = [model.fusion] # [model.network[-1][-2]]
