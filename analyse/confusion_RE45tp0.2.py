...
if __name__ == '__main__':
    ...
    display_labels = ("airplane", "airport", "baseball_diamond", "basketball_court", "beach", "bridge", "chaparral", "church",
    ...
    plt.savefig('../ConfusionMatrix_RE45.png', dpi=500, bbox_inches='tight')
    plt.show()
