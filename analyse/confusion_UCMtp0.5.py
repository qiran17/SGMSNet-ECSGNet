...
if __name__ == '__main__':
    ...
    model_path = "../ECSGNet_UCMtp0.5_time2-best.pth"
    num_class = 21
    batch_size = 4
    show_figure = True
    normalization = True
    # 模型不同类别的名称，默认已0，1，2，3......代替不同的类别名称，想要自定义的话，可以自己传列表进来。
    display_labels =('agricultural', 'airplane', 'baseballdiamond', 'beach', 'buildings', 'chaparral', 'denseresidential', 'forest',
    ...
    plt.savefig('../ConfusionMatrix_UCM.png', dpi=500, bbox_inches='tight')
    plt.show()
