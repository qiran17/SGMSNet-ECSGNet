...
model_name='ECSGNet_RE45tp0.1_time3'
# 定义数据集路径
train_dir = './RE45tp0.1/train'
val_dir = './RE45tp0.1/val'
test_dir = './RE45tp0.1/test'
# batch_size与类别数
batch_size = 16
n_classes = 45
# 定义数据预处理
...
# 中心损失函数
loss_weight = 0.001
center_loss = CenterLoss(num_classes=45, feat_dim=512, use_gpu=True)
