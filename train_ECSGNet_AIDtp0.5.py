...
model_name='ECSGNet_AIDtp0.5_time1'
# 定义数据集路径
train_dir = './AIDtp0.5/train'
val_dir = './AIDtp0.5/val'
test_dir = './AIDtp0.5/test'
# batch_size与类别数
batch_size = 16
n_classes = 30
# 定义数据预处理
...
# 中心损失函数
loss_weight = 0.001
center_loss = CenterLoss(num_classes=30, feat_dim=512, use_gpu=True)
